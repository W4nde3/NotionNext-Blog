...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '369f9a61d9aa41b4a84c9b22e97bced6',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'W4nder', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Keep Independent Thinking', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.wonderhow.run', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, Blog, W4nder', // 网站关键词 英文逗号隔开
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'W4nder‘s BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
